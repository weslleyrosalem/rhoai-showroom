...
<section aria-live="polite"><h2>A decision with evidence</h2><div id="status" class="status">Ready for your test drive.</div><div id="answer" class="answer muted">Your answer will appear here with its sources and tool calls.</div><div id="decision" hidden class="status"></div><div id="meta" hidden><strong>Sources consulted</strong><div id="sources"></div><p><strong>MCP tools</strong><br><span id="tools"></span></p><p><strong>MLflow trace</strong><br><code id="trace"></code></p><p id="usage" class="muted"></p></div></section></main>
